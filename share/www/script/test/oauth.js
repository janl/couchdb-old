...
couchTests.oauth = function(debug) {
  ...
  var adminBasicAuthHeader = function() {
    var b64pad = "=";
    return 'Basic ' + binb2b64(str2binb("testadmin:" + testadminPassword));
  }
  ...
  var testFun = function () {
    try {
      ...
      var usersDb = new CouchDB("test_suite_users", {
        ...
        "Authorization": adminBasicAuthHeader()
      });
      usersDb.deleteDb();
      usersDb.createDb();
        
      // Create a user
      T(CouchDB.createUser("jason", "testpassword", "test@somemail.com", ['test'], adminBasicAuthHeader()).ok);
